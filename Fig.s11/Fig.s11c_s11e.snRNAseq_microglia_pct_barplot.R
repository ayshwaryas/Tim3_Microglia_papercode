...
# Extended Data Fig.11c: Percentage barplot by cluster, colored by mouse ID -------------------------------
...
# Extended Data Fig.11d: Percentage barplot by cluster, colored by genotype -------------------------------
...
# Extended Data Fig.11e: Percentage barplot by Mouse_ID, colored by cluster -------------------------------
