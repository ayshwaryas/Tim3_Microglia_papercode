...
load("results/bulkRNAseq_results_ds1_batch2_7month.RData")
...
overlap_ds1_batch2_tim3_5XFAD_F_sig <- perm_test(
  set1 = ds1_batch2_tim3_F_DEGs, set2 = ds1_batch2_5XFAD_F_DEGs,
  all_genes1 = results_batch2_F$Tim3cKO_vs_control$gene_name, 
  all_genes2 = results_batch2_F$`5XFAD_vs_control`$gene_name,
  name1 = "Tim3cKO", name2 = "5XFAD", n_perm = 10000,
  prefix1 = paste0("DS1_Batch2_F_"),
  prefix2 = paste0("DS1_Batch2_F_")
)

# Extended Data Fig. 11b: Circos plot comparison of up- and down-regulated DEGs from 7-month-old mice ------------------------------
## Comparison 1: Havcr2cKO vs control
## Comparison 2: 5XFAD vs control

circo_overlap(res1 = ds1_batch2_tim3_F_DEGs, res2 = ds1_batch2_5XFAD_F_DEGs,
              name1 = "Havcr2cKO", name2 = "5XFAD", circo_pal = pal_text,
              overlap_perm_test = overlap_ds1_batch2_tim3_5XFAD_F_sig,
              gene_cex = 0.7, small_gap = 1.4, suffix = "top300_F",
              size = 7.5, gene_width = 10, degree = 100,
