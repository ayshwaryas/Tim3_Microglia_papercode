...
ggsave('figures/Fig.s10b_nucseq_Sun_2023_MG0to12_Top25Markers_sub2.png', width = 10, height = 3)
ggsave('figures/Fig.s10b_nucseq_Sun_2023_MG0to12_Top25Markers_sub2.pdf', width = 10, height = 3)
