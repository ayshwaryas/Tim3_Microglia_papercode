...
# Boxplot of pairwise Spearman correlation of pseudobulk expression between conditions ----------
...
ggsave("figures/Fig.16a_pseudobulk_corr_stripchart.png", height = 5, width = 4.3)
ggsave("figures/Fig.16a_pseudobulk_corr_stripchart.pdf", height = 5, width = 4.3)
