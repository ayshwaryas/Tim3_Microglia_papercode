...
# Extended Data Fig.7l: MGnD signature score ----------------
...
ggsave("figures/Fig.6_nucseq_figures/Fig.s7l_vln_up_in_clec7a.png", width = 9, height = 2.7)
ggsave("figures/Fig.6_nucseq_figures/Fig.S7l_vln_up_in_clec7a.pdf", width = 9, height = 2.7)

# Extended Data Fig.7m: Homeostasis signature score ----------------
...
ggsave("figures/Fig.6_nucseq_figures/Fig.s7m_vln_down_in_clec7a.png", width = 9, height = 2.7)
ggsave("figures/Fig.6_nucseq_figures/Fig.s7m_vln_down_in_clec7a.pdf", width = 9, height = 2.7)
