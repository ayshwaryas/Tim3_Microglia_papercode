...
perc_bar <- function(SeuratObject, group_by = "new_clusters", fill_by = "orig.ident", pal = NULL, title = NULL,
  ...
  filename <- paste("figures/Fig.6_nucseq_figures/Fig.s7_perc_bar", group_by, "by", fill_by, sep = "_")
...
# Extended Data Fig.7h: Percentage barplot by cluster, colored by mouse ID -------------------------------
...
# Extended Data Fig.7i: Percentage barplot by cluster, colored by genotype -------------------------------
...
# Extended Data Fig.7j: Percentage barplot by Mouse_ID, colored by cluster -------------------------------
