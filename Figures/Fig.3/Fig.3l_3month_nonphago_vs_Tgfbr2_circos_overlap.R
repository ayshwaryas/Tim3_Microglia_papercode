...
write.csv(overlap_ds1_tim3_phago_sig$p_overlap_perm, 
          "Source_Data/Fig.3l_perm_test.csv")
# Fig. 3l: Circos plot comparison of up- and down-regulated DEGs from 3-month-old mice ------------------------------
...
circo_overlap(res1 = ds1_batch1_tim3_sig,
              ...
              nudge_x = c(0, 0, 50, -50), Fig_num = "3l",
